...
| **Check if Strings Can be Made Equal With Operations I** | `Easy` | `java` | [LeetCode](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i/) | [Local Solution](../../problems/2839-check-if-strings-can-be-made-equal-with-operations-i/) |
...
| **Delete Characters to Make Fancy String** | `Easy` | `java` | [LeetCode](https://leetcode.com/problems/delete-characters-to-make-fancy-string/) | [Local Solution](../../problems/1957-delete-characters-to-make-fancy-string/) |
| **Detect Capital** | `Easy` | `java` | [LeetCode](https://leetcode.com/problems/detect-capital/) | [Local Solution](../../problems/0520-detect-capital/) |
...
| **Furthest Point From Origin** | `Easy` | `java` | [LeetCode](https://leetcode.com/problems/furthest-point-from-origin/) | [Local Solution](../../problems/2833-furthest-point-from-origin/) |
...
| **Goat Latin** | `Easy` | `java` | [LeetCode](https://leetcode.com/problems/goat-latin/) | [Local Solution](../../problems/0824-goat-latin/) |
